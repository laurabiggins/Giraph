...
public class SVGGenerator {
	...
	private StringBuffer svgCode = new StringBuffer();
	...
	public static String convertToSVG (Component c) {
		...
		SVGGenerator s = new SVGGenerator(c);
		if (doubleBuffered) {
	 ...
	 * @param c The component to convert
	 */
	private SVGGenerator (Component c) {
		...
		svgCode.append("<!DOCTYPE svg PUBLIC \"-//W3C//DTD SVG 1.1//EN\" \"http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd\">\n");
		svgCode.append("<svg width=\"");
		svgCode.append(c.getWidth());
		svgCode.append("\" height=\"");
		svgCode.append(c.getHeight());
		svgCode.append("\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\">\n");
	...
	/**
	 * Get the current SVG assembly.
	 * 
	 * @return The currently stored SVG code
	 */
	...
	private class SVGGraphics extends Graphics {
		...
		public void drawLine(int x1, int y1, int x2, int y2) {
			...
			svgCode.append("\" y2 = \"");
			svgCode.append(y2);
			svgCode.append("\" stroke = \"rgb(");
			appendColor();
			svgCode.append(")\" stroke-width = \"1\"/>\n");
		}
		...
		public void drawOval(int x, int y, int width, int height) {
			...
			svgCode.append("<ellipse cx=\"");
			svgCode.append(x);
			svgCode.append("\" cy=\"");
			svgCode.append(y);
			svgCode.append("\" rx=\"");
			svgCode.append(width);
			svgCode.append("\" ry=\"");
			svgCode.append(height);
			svgCode.append("\" style=\"fill:none;stroke:rgb(");
			appendColor();
			svgCode.append(");stroke-width:1\"/>\n");
		}
		...
		public void fillOval(int x, int y, int width, int height) {
			...
			svgCode.append("\" ry=\"");
			svgCode.append(height);
			svgCode.append("\" style=\"fill:rgb(");
			appendColor();
			svgCode.append(");stroke:none;stroke-width:0\"/>\n");
		}
		...
		public void drawString(String string, int x, int y) {
			...
			svgCode.append("<text x = \"");
			svgCode.append(x);
			svgCode.append("\" y = \"");
			svgCode.append(y);
			svgCode.append("\" fill = \"rgb(");
			appendColor();
			svgCode.append(")\" font-family=\"sans-serif\" font-size = \"");
			svgCode.append(font.getSize());
			svgCode.append("\">");
			svgCode.append(string);
			svgCode.append("</text>\n");
		}
		...
		public void drawRoundRect(int x, int y, int width, int height, int arcWidth,int arcHeight) {
			...
			svgCode.append(y);
			svgCode.append("\" rx=\"");
			svgCode.append(arcWidth);
			svgCode.append("\" ry=\"");
			svgCode.append(arcHeight);
			svgCode.append("\" style=\"fill:none");
			svgCode.append(";stroke-width:1;stroke:rgb(");
		...
		public void fillRoundRect(int x, int y, int width, int height, int arcWidth,int arcHeight) {
			...
			svgCode.append(");stroke-width:0;stroke:none\"/>\n");
		}
		...
		private void appendColor () {
			svgCode.append(color.getRed());
			svgCode.append(",");
			svgCode.append(color.getGreen());
			svgCode.append(",");
			svgCode.append(color.getBlue());
		}
		...
		public void drawPolygon(int[] arg0, int[] arg1, int arg2) {
			System.out.println("Draw polygon 1");
		}
		...
		public void fillPolygon(int[] arg0, int[] arg1, int arg2) {
			System.out.println("Fill polygon");
		}
